...
TEXT_W = PW - MARGIN_GUTTER - MARGIN_OUTER
TEXT_H = PH - MARGIN_TOP - MARGIN_BOTTOM
...
def header_footer(cv, doc, page_kind):
    ...
    if page_kind == "body":
        ...
        if is_recto:
            cv.drawRightString(PW - MARGIN_OUTER, PH - MARGIN_TOP + 20, htext)
        else:
            cv.drawString(MARGIN_GUTTER, PH - MARGIN_TOP + 20, htext)
        # folio
        cv.setFont("Lora", 8.5)
        cv.setFillColor(INK)
        cv.drawCentredString(PW / 2, MARGIN_BOTTOM - 22, str(page_no))
...
frame_body = Frame(MARGIN_GUTTER, MARGIN_BOTTOM, TEXT_W, TEXT_H, id="body",
                    leftPadding=0, rightPadding=0, topPadding=0, bottomPadding=0)
frame_opener = Frame(MARGIN_GUTTER, MARGIN_BOTTOM, TEXT_W, TEXT_H - 0.5 * inch, id="opener",
                      leftPadding=0, rightPadding=0, topPadding=0, bottomPadding=0)
frame_full = Frame(0, 0, PW, PH, id="full", leftPadding=0, rightPadding=0, topPadding=0, bottomPadding=0)
frame_manga = Frame(MARGIN_GUTTER, MARGIN_BOTTOM, TEXT_W, TEXT_H, id="mangaframe",
                     leftPadding=0, rightPadding=0, topPadding=0, bottomPadding=0)
frame_front = Frame(MARGIN_GUTTER, MARGIN_BOTTOM, TEXT_W, TEXT_H, id="front",
                     leftPadding=0, rightPadding=0, topPadding=0, bottomPadding=0)
...
pt_manga = PageTemplate(id="Manga", frames=[frame_full], onPage=onPage_manga)
...
frame_poem = Frame(MARGIN_GUTTER, MARGIN_BOTTOM, TEXT_W, TEXT_H, id="poem",
                    leftPadding=0, rightPadding=0, topPadding=0, bottomPadding=0)
...
def build_story(add_parity_blank=False):
    story = []
