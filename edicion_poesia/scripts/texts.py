#!/usr/bin/env python3
"""Textos multilingües para los PDFs y EPUBs."""
...
TEXTS = {
    "es": {
        ...
        "illustrations_title": "Las ilustraciones",
        "about_title": "Sobre esta antología",
        ...
        "credits_text": (
            ...
            f"de la misma obra. Al final del volumen se relacionan una a una.</p>"
            f"<p>Compuesto en Source Serif Pro.</p>"
    ...
    "ca": {
        ...
        "about": [
            ...
            "ciutat de Tarel, suspesa sobre una aigua que un dia es retira. I aquesta "
            "antologia, que tradueix el mateix al llenguatge del sentiment.",

            "Els tres camins són independents i porten al mateix lloc. Es pot "
            "entrar per qualsevol d'ells.",

            "**Íñigo Barrera Barceló** va escriure *L'Horitzó Interior* durant diversos "
            "anys, als moments que deixa una vida que també succeïa. El llibre està "
            "dedicat a Montse i a Gerard, per aguantar-li tots els dies amb un "
            "somriure. Diversos dels poemes d'aquest volum porten els seus noms, o els "
            "porten sense dir-ho.",

            "L'obra completa —assaig, contes, poemes, edició jove i les "
            "il·lustracions de les quals surten aquestes làmines— pot llegir-se també en la seva "
            "versió interactiva.",
        ],
        "illustrations_title": "Les il·lustracions",
        "about_title": "Sobre aquesta antologia",
        ...
        "credits_text": (
            ...
            f"de la mateixa obra. Al final del volum es relacionen una a una.</p>"
            f"<p>Compost en Source Serif Pro.</p>"
            f"<p>ISBN: 9798175383530</p>"
        ),
...
def get_text(lang: str, key: str):
    """Obtiene el texto traducido para el idioma y clave especificados."""
    if lang not in TEXTS:
        lang = "es"
    if key not in TEXTS[lang]:
        return TEXTS["es"].get(key, "")
