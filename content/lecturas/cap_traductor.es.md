...
> **En física esto se llama:** un amplificador con control de ganancia a la salida que además recorta selectivamente el ruido de retorno antes de que llegue a realimentar la fuente.  
> **En software esto se llama:** una capa de logging que solo deja pasar a las alertas del equipo los errores por encima de cierto umbral, y silencia el resto antes de que lleguen a la fuente.  
> **En la vida diaria es como:** un representante que negocia el contrato y, además, decide qué cartas —y qué críticas— llegan siquiera a abrirse.
