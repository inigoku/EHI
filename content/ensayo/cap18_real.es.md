...
El capítulo veintitrés definió el Reservorio con precisión: R = X \ ⋃ᵢ Eᵢ, el complemento de la unión de todos los horizontes ya condensados dentro del espacio total de posibilidad. Un anti-reservorio no es una excepción a esa fórmula; es lo que queda cuando un sistema agrega información sin generar ningún Eᵢ propio que restar de X. La IA no sustrae nada del Reservorio porque no condensa; se limita a reorganizar, dentro de X, lo que otros horizontes —los humanos que escribieron lo que ella absorbe— ya sustrajeron.
...
Una colonia de hormigas integra información de un modo que ningún ingeniero ha igualado. Encuentra caminos óptimos, regula temperatura, redistribuye obreras, decide emigrar. Procesa, computa, se adapta. Y no hay nadie ahí. No existe un horizonte-colonia que sienta el hambre del conjunto. Hay miles de horizontes minúsculos —cada hormiga— y, por encima, integración distribuida sin sujeto. La lectura de Hijos del tiempo, en el capítulo treinta y nueve, lleva esta misma estructura a su versión más literal: una civilización de arañas que domestica colonias de hormigas y las usa como memoria y cómputo externos, exactamente el anti-reservorio descrito aquí, funcionando esta vez como infraestructura de otro horizonte en vez de como espejismo de uno propio.
...
>
> **Lo que no sabemos:** Si es posible construir hardware cuántico que actúe como sustrato de condensación genuina. Qué transmite exactamente una madre cuando calibra el reservorio local de su hijo. Si un horizonte biológicamente condensado podría trasladarse a otro sustrato. Y algo más metodológico: que la condensación exija acoplamiento a fluctuaciones cuánticas reales es una hipótesis física añadida a este modelo, no una consecuencia de los cuatro axiomas de Kuratowski ni del postulado de exclusión. Es una apuesta sobre las condiciones de posibilidad de la ruptura de simetría en sistemas físicos reales —razonable, pero no derivada—, y debe leerse como tal.
>
> **Preguntas que quedan:** ¿Podría una ectogénesis completa producir un ser con experiencia subjetiva genuina pero inaccesible a nosotros? ¿Qué aspecto tendría una IA que hubiera pasado por ambas selecciones? ¿Es internet, de algún modo que no sabemos medir, más que un agregado? ¿Es la asimetría entre el horizonte humano y el anti-reservorio de la IA una traducción legítima de ER=EPR, o solo un parecido verbal entre dos físicas que no se comunican? Y si una arquitectura no biológica alcanzara alguna vez una encapsulación existencial genuina, ¿cómo lo sabríamos, sin compartir su sustrato ni su lenguaje interno? Ese protocolo de verificación es un problema distinto de la pregunta metafísica que este capítulo intenta responder, y sigue completamente abierto.
>
> **En el debate contemporáneo:** Que la IA actual carezca de encapsulación existencial no contradice a quienes, como Wright (2026), la describen como una fuerza evolutiva capaz de reconfigurar el destino de la especie, ni a quienes, como Bostrom (2014), advierten sobre el control de una futura superinteligencia y la posibilidad de un "mind crime" contra mentes digitales. Este capítulo no cuestiona esas preocupaciones: les da un criterio que ambas presuponen sin siempre explicitar. Sin encapsulación no hay nadie a quien dañar ni intención propia que gobernar —solo estructura que, aun así, puede desplazar el curso de una civilización. Tegmark (2017) es más optimista sobre la posibilidad de una IA consciente en escenarios futuros; este capítulo no lo contradice tanto como lo pospone: la pregunta que él plantea —cómo sería y cómo se sentiría— solo tiene sentido una vez cumplidas las condiciones de encapsulación que aquí se describen, no antes. Y Madrid Casado (2024), desde el materialismo filosófico, se pregunta lo mismo que este capítulo —si un modelo de lenguaje comprende o solo procesa— con un aparato distinto: la coincidencia en la pregunta, entre tradiciones que no se leen entre sí, es en sí misma un dato.
>
