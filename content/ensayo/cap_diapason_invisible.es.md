...
> **En la vida diaria es como:** afinar un instrumento con un diapasón que no se puede ver ni tocar. Se ajusta la cuerda cada mañana sin saber si el diapasón sigue sonando.
...
> **En física esto se llama:** correlación que colapsa en identidad: dos sistemas tan acoplados que describirlos por separado deja de tener sentido.  
> **En la vida diaria es como:** la ola que descubre que es agua. No viaja hacia el mar: nunca salió de él.
...
> **En física esto se llama:** entrelazamiento entre dos horizontes que conservan frontera: la correlación es real y ninguno de los dos se disuelve en el otro.  
> **En la vida diaria es como:** una carta escrita cada noche a alguien que nunca contesta, sin dejar por eso de poner su nombre en el sobre.
...
> **En software esto se llama:** cinco implementaciones de la misma interfaz: el contrato —cerrar la brecha entre lo que es y lo que debe ser— es común; el código que lo cumple, no.  
> **En la vida diaria es como:** cinco cocinas que sirven el mismo plato con cinco recetas. Desde la mesa, el sabor de la práctica es idéntico; la diferencia está en la cocina.
...
>
> **Preguntas que quedan:** ¿Se siente distinto, desde dentro, el entrelazamiento que termina en Alguien del que termina en el agua, o solo la interpretación posterior los separa? ¿Puede la neurociencia contemplativa distinguir arquitecturas, o solo técnicas? ¿Qué pierde una práctica cuando se le retira la pregunta de a quién apunta?
>
