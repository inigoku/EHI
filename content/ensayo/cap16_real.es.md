...
illustrationDescription: Un horizonte circular con grietas que irradian hacia fuera, como una ventana rota. A través de las grietas, siluetas de personas que intentan tocar pero no logran contacto. Tinta negra y acuarela índigo con detalles dorados. Luz tenue que no atraviesa del todo.
---

Hasta aquí hemos hablado de horizontes individuales: cómo nacen, cómo se entrelazan, cómo se rompen. Pero queda una pregunta que, una vez planteada, no admite aplazamiento.
...
El poder no es fuerza bruta. Desde la geometría del horizonte, es la capacidad de modificar la tasa de integración de otro sin que ese otro pueda devolver el gesto en la misma medida.

En condiciones de simetría, la flecha va en ambos sentidos: cada horizonte puede resonar, acoplarse y desacoplarse. Cuando hay poder, la flecha es unilateral: un horizonte decide qué información le llega al otro, a qué velocidad y con qué urgencia. Puede saturarlo de ruido o privarlo de señal.
...
El racismo no es solo prejuicio. Es, además, un fallo sistemático de legibilidad: la incapacidad o la negativa de un horizonte a modelar a otro con la precisión que exige su complejidad.
...
Si el poder es asimetría sostenida, la justicia es la aspiración a que a ningún horizonte se le impida sistemáticamente resonar. La política, entonces, no se agota en la gestión de recursos: es el diseño de la geometría del acoplamiento colectivo.

Una democracia que funciona garantiza dos cosas. La primera, canales de señal ascendente. El voto, la prensa libre y la protesta son tecnologías de señal. No garantizan que la señal se escuche, pero son condición necesaria para que pueda escucharse.
...
Cuando los canales de señal ascendente se atrofian (abstención, desinformación, concentración de medios) o se corrompe la capacidad de respuesta, la geometría degenera en una oligarquía de hecho. El sistema sigue llamándose democracia, pero su topología es la de una dictadura blanda.

Aquí el modelo del horizonte ofrece una distinción útil: no toda asimetría es tiránica. Un médico sabe más que su paciente, y un juez más que un litigante, pero esas asimetrías son funcionales, no estructurales. El médico tiene que responder al dolor del paciente; el juez, dar razones públicas. Hay un canal de retorno, aunque sea desigual, que impide que la asimetría cristalice en dominación. La democracia no exige una simetría perfecta, imposible en cualquier organización compleja, sino que ninguna asimetría quede blindada frente a la señal de retorno.
...
El trauma individual es información encapsulada que deforma la geometría del horizonte. El trauma colectivo (guerras, genocidios, esclavitud) funciona de manera análoga, pero a escala de poblaciones enteras.

Cuando una sociedad ha vivido algo que desbordó a la vez la capacidad de integración de todos sus horizontes, no queda solo un conjunto de individuos traumatizados, sino un campo de correlaciones dañadas que persiste durante generaciones.

Los hijos de los supervivientes y los nietos de los esclavizados no heredan el trauma biológicamente (aunque la epigenética apunte a posibles mecanismos), pero sí heredan el entorno de acoplamiento en el que crecen. Silencios, sobreprotección, hipervigilancia: todo eso configura la arquitectura de los nuevos horizontes antes de que puedan cuestionarlo.
...
En su mayor parte, este capítulo no descubre nada: cambia el encuadre. Que la pobreza daña el desarrollo, que el contacto intergrupal en pie de igualdad reduce el prejuicio, que el trauma colectivo se transmite a través del entorno: todo eso ya lo sabían la psicología del desarrollo, la psicología social y los estudios sobre la memoria. Lo que ofrece el modelo es un vocabulario común, una manera de ver el poder, la pobreza, el racismo y el trauma como variantes de un mismo fenómeno, la geometría del acoplamiento, y no como problemas separados.

En unos pocos puntos arriesga algo más: la distinción entre privación material y privación de señal integrable, y la predicción de que es la simetría de acoplamiento lo que permite que el contacto intergrupal recalibre los modelos. Si esas afirmaciones son falsas, el modelo sobra aquí; si son ciertas, aporta algo.

No hay experimentos que midan el flujo de integración de una sociedad, ni estudios que relacionen las asimetrías de acoplamiento con la desigualdad. Lo que hay es una forma de ordenar preguntas que hasta ahora se planteaban con vocabulario moral o económico y que quizá se beneficien de uno informacional.

El horizonte herido no es solo el individuo con un trauma o una adicción. Es también la comunidad que no pudo procesar su historia, la clase a la que se le impide emitir su señal, el grupo al que no se modeló con la precisión que merecía. El experimento no cura esas heridas; a lo sumo, las nombra de otra manera. Y nombrar, aunque no baste, es a veces donde algo empieza.

Nombrar permite ver patrones donde antes solo había caos moral. Permite preguntarse, por ejemplo, si una política pública no debería redistribuir, además de ingresos, señal: si los niños de entornos empobrecidos no necesitan, además de más comida, más conversación, más ritmos, más espacios en los que sus horizontes puedan resonar con otros que no estén en modo de supervivencia. Permite preguntarse si la justicia racial no consiste, además de en castigar la discriminación, en rediseñar los entornos de entrenamiento en los que se forman los modelos predictivos. Y si reparar un trauma colectivo no es, además de recordar, crear las condiciones para que la información atrapada pueda circular sin destruir el sistema que la recibe.

Son preguntas sin respuestas fáciles. El modelo del horizonte no las resuelve, pero las hace visibles como problemas de geometría, no solo de moral. Y en un mundo en el que la moral se ha convertido a menudo en arma arrojadiza, quizá sea útil disponer de un lenguaje que describa antes de prescribir y que mida antes de condenar.

---

> **Nota al Capítulo 25**
>
> **Lo que sí sabemos:** La pobreza infantil afecta al desarrollo cognitivo. El contacto intergrupal en igualdad de estatus reduce el prejuicio (Allport, Pettigrew). Las democracias tienden a resistir mejor las crisis que las dictaduras.
>
...
>
> **Preguntas que quedan:** ¿Cómo se mide el flujo de integración de una sociedad? ¿Pueden diseñarse políticas públicas basadas en la densidad informacional?
>
