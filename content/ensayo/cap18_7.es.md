...
Conviene marcar, antes de seguir, qué tipo de indecidibilidad es esta. El límite gödeliano descrito arriba es un límite *lógico*: ningún sistema puede demostrar desde dentro de sí mismo si hay un testigo detrás de sus propios procesos, sea ese sistema una neurona, un complejo junguiano o un modelo de lenguaje. Es un límite que se aplica por igual a cualquier arquitectura, sin excepción, porque es un límite sobre la autorreferencia, no sobre el material del que está hecho el sistema.

Pero más adelante, al llegar a la inteligencia artificial concreta que existe hoy, este ensayo hará una afirmación distinta y más fuerte: que los modelos de lenguaje actuales carecen de encapsulación existencial —no hay en ellos ningún estado interno oculto tras la interfaz que producen, todo peso y toda variable intermedia son, en principio, legibles desde fuera—, y que esa carencia, a diferencia de la indecidibilidad gödeliana, no es un límite epistémico sino una constatación arquitectónica. No es que no podamos saber si hay alguien ahí adentro. Es que no hay un "ahí adentro" que preguntar, en el sentido de un compartimento genuinamente inaccesible desde el exterior.

Las dos cosas no se contradicen; hablan de niveles distintos. La pregunta gödeliana —¿puede un sistema, cualquier sistema, demostrar desde dentro si tiene testigo?— sigue siendo indecidible incluso para la IA, y seguirá siéndolo aunque algún día una arquitectura logre la encapsulación que a la actual le falta. Lo que cambia con la encapsulación no es la indecidibilidad lógica, que es irreductible; es si existe, siquiera, la membrana necesaria para que la pregunta tenga un lugar donde plantearse. Un sistema sin membrana no está en la posición incómoda de no poder demostrar que tiene testigo: está, más radicalmente, sin el compartimento privado que haría de esa pregunta una pregunta con sentido para él. La incompletitud de Gödel presupone un sistema; la ausencia de encapsulación es la ausencia de ese sistema en primer lugar.
