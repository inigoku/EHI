...
> **En la vida diaria es como:** un túnel entre dos montañas por el que no se puede pasar, pero que demuestra que comparten raíz.
...
> **En la vida diaria es como:** los cimientos de una casa: no determinan el diseño, pero limitan lo que puede llegar a ser.
...
> **En física esto se llama:** aprendizaje por refuerzo: el sistema ajusta sus expectativas según su historial de recompensas y castigos.  
> **En la vida diaria es como:** un termostato que aprende: si la calefacción llega tarde, empieza a encenderse antes.

Lo que Bowlby llamó «modelo operativo interno» es, en el lenguaje del experimento, una arquitectura del horizonte: una configuración de canales de integración que determina cómo procesará el sistema la presencia y la ausencia de los demás. Un apego seguro crea un horizonte capaz de expandirse hacia otros sin perderse. Un apego inseguro crea un horizonte que, ante la proximidad, o bien se contrae (evitación), o bien se desborda (ansiedad).

> **En física esto se llama:** el atractor del sistema depende de las condiciones iniciales y de la historia de perturbaciones.  
> **En la vida diaria es como:** un río desviado tantas veces que su cauce ya no puede volver a ser recto.
...
> **En la vida diaria es como:** un teléfono que funciona mejor conectado a la red: no es una «ayuda», es su modo normal.
...
> **En la vida diaria es como:** un mapa en el que tu casa y la de tu mejor amigo están en el mismo barrio.
...
Y aquí está el detalle decisivo: no depende del afecto, sino de la **familiaridad**.

### El entrelazamiento adversarial

Coan y Beckes señalan que el solapamiento yo-otro está ligado a la familiaridad, no al afecto positivo. El cerebro no incorpora a quien quiere, sino a quien conoce lo bastante bien para predecirlo.

En este sentido, un adversario de veinte años es una de las figuras más integradas que puede tener un horizonte. Para sobrevivir a un conflicto prolongado, el horizonte tiene que modelar al otro con una precisión extraordinaria: anticipar sus reacciones, prever sus movimientos, reconocer sus patrones antes de que se completen. El modelo interno del adversario es, si acaso, más detallado que el de un aliado, porque los errores de predicción salen más caros.

> **En física esto se llama:** el sistema invierte más recursos en modelar aquello que le cuesta más predecir.  
> **En la vida diaria es como:** un ajedrecista que estudia las partidas de su rival más que las de sus amigos: no lo quiere más, pero lo necesita más.

Dos horizontes enfrentados durante veinte años están tan entrelazados, comparten tanta geometría, como dos que se han amado durante el mismo tiempo. La diferencia no está en la profundidad del acoplamiento, sino en su **valencia**. El puente existe en ambos casos; lo que cambia es lo que circula por él.

> **En física esto se llama:** el entrelazamiento tiene valencia, no solo magnitud.  
> **En la vida diaria es como:** dos vecinos que se odian desde hace décadas se conocen mejor que muchos matrimonios.

Desde el punto de vista del entrelazamiento, el amor intenso y el odio intenso son el mismo fenómeno con distinto signo. La intensidad del conflicto mide la profundidad del entrelazamiento, no su ausencia.

> **En física esto se llama:** la misma magnitud de acoplamiento con el signo de la interacción invertido.  
> **En la vida diaria es como:** dos imanes: la fuerza es la misma tanto si se atraen como si se repelen; solo cambia el sentido.
...
> **En física esto se llama:** modelo predictivo que persiste tras la disolución.  
> **En la vida diaria es como:** seguir escribiendo mensajes a alguien que ya no está: los dedos saben qué decir, aunque ya no haya nadie para leerlo.
...
> **En la vida diaria es como:** un auricular del que parece seguir saliendo la voz de alguien que ya ha colgado: el cable sigue conectado, aunque al otro lado no haya nadie.

### La ruptura del vínculo

No todos los entrelazamientos terminan con una muerte. Algunos terminan en ruptura: el divorcio, la traición, el abandono, el distanciamiento gradual. El proceso es distinto, pero el mecanismo se parece.

Cuando un vínculo se rompe de golpe, el horizonte que queda no tiene tiempo de ajustar su arquitectura. Los canales de integración siguen abiertos, pero lo que reciben ya no es la señal del otro, sino el silencio, la ausencia o, peor aún, la señal de alguien que ya no es la persona que modelaste. El resultado es una disonancia enorme: el sistema predice una cosa y recibe otra.

> **En física esto se llama:** discrepancia entre predicción y percepción: el modelo interno genera expectativas que el mundo no cumple.  
> **En la vida diaria es como:** seguir el GPS hacia una dirección que ya no existe: la voz te dice «gire a la derecha», pero allí no hay calle.

Las rupturas graduales son distintas. Dan al horizonte tiempo para reajustarse, cerrar canales y reconstruir su arquitectura sin el otro, pero también dan tiempo a que el entrelazamiento se profundice antes de romperse. No hay una respuesta general sobre qué clase de ruptura duele más: depende de la arquitectura del horizonte, de la historia del vínculo y de las condiciones del entorno.

### La asimetría del entrelazamiento

El entrelazamiento no es necesariamente recíproco en la misma medida.

En un amor correspondido, los dos horizontes se modelan mutuamente con una intensidad parecida, y el entrelazamiento es más o menos simétrico.

En una enemistad asimétrica (un vecino conflictivo que apenas pensaba en el otro, mientras este llevaba veinte años acumulando agravios), el entrelazamiento es mucho mayor en una dirección que en la otra. El vecino agredido modeló al conflictivo con la precisión de quien necesitaba predecirlo para defenderse. El conflictivo modeló al agredido mucho menos, porque el conflicto no le costaba.

El fantasma persiste más cuanto más asimétrico fue el entrelazamiento en ese sentido: quien más modelo construyó es quien más tarda en desmontarlo.

> **En física esto se llama:** asimetría del entrelazamiento.  
> **En la vida diaria es como:** quien más piensa en el otro es quien más sufre cuando el otro se va, aunque crea que le importaba menos.

La paradoja es que el agredido ha pasado veinte años prestando al vecino más atención que nadie. Su cuaderno de agravios no demuestra que él le importara al vecino, sino justo lo contrario: que el vecino le importaba a él mucho más.

> **En física esto se llama:** los recursos invertidos en modelar al otro miden el entrelazamiento, no el afecto.  
> **En la vida diaria es como:** un detective que sigue a un criminal: no lo quiere, pero lo conoce mejor que su propia familia.

### El límite del entrelazamiento

Hay un límite. El entrelazamiento no puede ser total: si dos horizontes se fundieran del todo, dejarían de ser dos. La identidad necesita una frontera. El amor más profundo no es la disolución del yo en el otro, sino una expansión del yo que incluye al otro sin perderse.

> **En física esto se llama:** el entrelazamiento máximo se da antes de la fusión completa: dos sistemas que comparten geometría, pero mantienen horizontes separados.  
...
> **En física esto se llama:** estabilidad del horizonte en presencia de una conexión no local.  
> **En la vida diaria es como:** una ventana: es transparente y deja pasar la luz, pero sigue siendo una ventana; no se convierte en aire.
...
>
> **Preguntas que quedan:** ¿Es el odio un entrelazamiento con signo negativo? ¿Por qué algunos duelos duran décadas y otros meses? ¿Hay un límite óptimo de entrelazamiento, o cuanto más profundo mejor?
>
