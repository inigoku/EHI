...
> **En física esto se llama:** transición de fase de primer orden: el sistema pasa de golpe de un estado desordenado a uno con estructura, sin estados intermedios estables.  
> **En la vida diaria es como:** agua sobreenfriada. Sigue líquida por debajo de cero hasta que un golpe la congela entera en un segundo.
...
> **En software esto se llama:** asociación, agregación y composición: tres relaciones entre objetos que se distinguen por si el ciclo de vida de la parte depende del ciclo de vida del todo.  
> **En la vida diaria es como:** el vecino con el que compartes ascensor, el club al que perteneces y un órgano de tu cuerpo. Puedes perder a los dos primeros y seguir siendo tú.
...
> **En física esto se llama:** homeostasis de la frontera: el sistema gasta energía en expulsar cualquier señal que amenace con romper su membrana, igual que un cuerpo defiende su temperatura.  
> **En la vida diaria es como:** una fiebre que sube no contra un virus, sino contra la pregunta de un amigo.
...
> **En física esto se llama:** confundir un sistema abierto con una condición de contorno: tratar un horizonte finito y revisable como si fuera un parámetro fijo del universo.  
> **En la vida diaria es como:** colgar en la pared, con marco de altar, la foto de alguien que envejece, se equivoca y mañana puede cambiar de opinión.
...
>
> **Preguntas que quedan:** ¿Puede una sociedad entera evitar la composición sin perder la fuerza de sus movimientos? ¿Hay un marcador que avise, desde dentro, del momento en que la pertenencia empieza a sustituir? ¿Qué hace falta para que una plaza llena conserve una pregunta?
>
> **Si solo te quedas con una idea:** Un horizonte colectivo sano te define sin sustituirte; el fanático captura tu frontera. La prueba no es el bando, sino si una pregunta razonable de un aliado se siente como información o como amenaza.
>
