...
// - cap_nota_autor (la nota original, sobre la colaboración con la IA) se
//   trasladó a group1.ts, entre el prólogo y el capítulo 1: funciona mejor
//   como declaración de intenciones que como cierre.
// - cap_notas_cierre reúne las notas del autor de los cuatro últimos libros
//   (la de El espejo sin profundidad era idéntica a la nota original).
...
//   capítulo.
const ORDER = ["cap_notas_cierre", "cap_glosario", "cap_notas_referencias"];
