...
import { BookOpen, Compass, ArrowDown, ArrowRight, ArrowLeft, Book, Feather, Waves, Network, Sparkles } from "lucide-react";
...
interface LandingPageProps {
  ...
  onStartReading: (mode: "essay" | "cuentos" | "poemas" | "joven", chapterId?: string) => void;
  openGlossary: () => void;
  initialPage?: number;
}
